...
description: Ionic helps you to create hybrid applications, the latest version of ionic is ionic 4. In this get started with ionic tutorial we will build a simple page.
