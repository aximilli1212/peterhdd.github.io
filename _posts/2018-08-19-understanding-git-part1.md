...
description: In this git tutorial, i will explain how to pull, push and clone repositories, after that you will be able to understand git. Also check understanding git part 2.
